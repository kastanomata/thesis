\chapter{Architettura e Sviluppo}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/slab/slab_allocator_change_order.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/external_fragmentation_visualization.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{images/buddy/buddy_binary_structure.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/buddy/buddy_internal_fragmentation.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/bitmap/bitmap_matchup.pdf}
...
Durante la deallocazione, il bit del blocco viene segnato come libero. Se anche il \textit{buddy} è libero, il bit del genitore è ricorsivamente posto a zero e diventa disponibile per accogliere future allocazioni.
